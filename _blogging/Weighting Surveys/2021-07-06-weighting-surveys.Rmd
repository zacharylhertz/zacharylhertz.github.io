...
In response, researchers often construct post-stratification weights to correct for sampling error and match the sample to the population on key characteristics. 
