...
Third, [others have noted](https://x.com/ZacharyDonnini/status/1887183300118069655)[^2] that San Francisco saw strong shifts towards Republicans in Asian neighborhoods but have failed to put the trend into context. Considering the historical context, down-ballot performance, trends, and neighborhood-level diversity adds to this analysis.

Fourth, and perhaps most importantly in motivating me to actually write this piece up, I actually know Lou from our time playing quiz bowl in high school.[^3] So, with these points in mind, I wrote up a short post to answer a few questions. Was Lou's (relatively) strong performance buoyed by a particular ability to leverage appeals to the Asian community, or did his loss simply mark a continuation of declining support for an aging Pelosi?

# Bruce Almighty
Before getting into the analysis, for the unfamiliar, *who* is Bruce Lou? As mentioned earlier, I first met Lou when we were both high school seniors: he at Saratoga High School, I at Davis Senior High School.[^4] He went on to attend UC Berkeley[^5] where he graduated with a degree in computer science in 2019.

After graduating, Lou worked as a software engineer and at [True Search](https://trueplatform.com/). He also started a consulting firm, [Stingray](https://stingray.vip/about-us), and helped fundraise/distribute pepper spray to Chinatown residents in 2021. During this time period, he had no notable public appearances in politics.[^6]
...
From the start Lou faced a clear uphill battle. San Francisco has been a Democratic enclave for decades, and Pelosi started the cycle with \$3.5 million cash on hand at the end of the previous cycle. Lou raised slightly more than \$208,000 over the course of the campaign.[^7] After placing second in the primary with 8.6 percent of the vote, Lou was officially set to challenge Pelosi in the general.

[![Lou on the campaign trail.](images/lou_campaign.jpeg)](https://x.com/RealBruceLou/status/1851740034908721667){width=40%}

Pelosi's status as a [nationally unpopular figure](https://www.realclearpolitics.com/epolls/other/nancy_pelosi_favorableunfavorable-6673.html)[^8] means that her challengers have frequently garnered national attention, and Lou was no exception. Lou parlayed his primary victory into a social media audience of more than 15,000 followers on X[^9] where he frequently posted videos[^10] filmed in front of the San Francisco skyline directly addressing Pelosi. But there was one person Lou failed to engage with these pillories: Pelosi herself. Neither [her official X account](https://x.com/search?q=bruce%20lou%20(from%3ASpeakerPelosi)&src=typed_query) nor [her personal account](https://x.com/search?q=bruce%20lou%20(from%3ATeamPelosi)&src=typed_query&f=top) mention Lou once. He also struggled to get coverage in local mainstream news outlets;[^11] nods to Lou's campaign in The San Francisco Chronicle are limited to [a closing paragraph](https://www.sfchronicle.com/election/article/bay-area-congress-primary-18689423.php) noting his primary victory and [a quick quote](https://www.sfchronicle.com/sf/article/chinese-trump-voters-19869459.php) in a story on Chinese-American Trump voters.

It should be no surprise, then, that when November rolled around Pelosi romped Lou by a seventy-point margin, 81.0 - 19.0 percent. But, as previously noted, there were some interesting findings under the hood of what seemed like another standard Democratic blowout. In this piece, I use the precinct-level results and Census data to investigate.
...
![Precinct-level map of 2022-2024 shifts in the district. Click to expand.](images/headline_22_24_shift.png){.lightbox width=1700}
...
![Precinct-level map of 2022-2024 shifts in the district normalized to citywide results. Click to expand.](images/normalized_22_24_shift.png){.lightbox width=1700}
...
![Scatterplot of 2022-2024 shifts in the district normalized to citywide results, by precinct Asian American population. Click to expand.](images/scatter_22_24_shift.png){.lightbox width=1700}
...
First, I regress Lou's vote share on the percent of a precinct that is Asian American. This uses the precinct's Asian American population to predict Lou's expected vote share. The residuals from this model are thus the difference between *how much of the vote we would expect Lou to get* in a precinct based only on its racial demographics, and how much of the vote *he actually received*. The results are visible in this interactive map, which you can scroll and zoom around at your pleasure.
...
![Scatterplot of residuals from the above map, by precinct's 2022 vote history. Click to expand.](images/residuals_22vote.png){.lightbox width=1700}
...
![Scatterplot of residuals from the above map, by precinct's 2022 vote history. Click to expand.](images/residuals_asianpop.png){.lightbox width=1700}
...
![Scatterplot of residuals from the above map, by Asian American population. Click to expand.](images/residuals_asianpoppres.png){.lightbox width=1700}
...
![Scatterplot of residuals from regression of Lou's vote share on Trump vote share, by Blau index. Click to expand.](images/residuals_blau.png){.lightbox width=1700}
...
[^2]: Astute readers may notice I commented in this thread. The OP kindly ignored my request for help finding data, so any complaints about delays in this piece should be directed to the other Zachary.
...
[^4]: I did not consult nor contact Lou ahead on the contents of this article before publishing this piece, though he did briefly DM me asking about it because I accidentally made a draft visible earlier than intended.

[^5]: Go Bears?

[^6]: A quick and dirty search [on the FEC website](https://www.fec.gov/data/receipts/individual-contributions/?contributor_name=bruce+lou&contributor_employer=stingray&max_date=12%2F31%2F2026) suggests that he did make some small donations to the California Republican Party prior to entering the race.

[^7]: Credit where it's due, Lou raised more than similarly long-shot candidates. Anna Cheng Kramer in CA-15 to the south [raised \$160,000](https://www.fec.gov/data/committee/C00847590/?cycle=2024) and in CA-02 to the north, Chris Coulombe [raised nearly \$124,000](https://www.fec.gov/data/candidate/H2CA02241/). All three Republican challengers failed to crack 30 percent of the vote.

[^8]: Forgive the RealClearPolitics link.

[^9]: The "everything app," fka. Twitter.

[^10]: His X.com account has 151 photos and videos. As a comparison, his campaign website has five total press releases, one of which predates the campaign and one of which is announcing his initial filing for Congress.

[^11]: With the exception of The Saratoga Falcon, of course.

[^12]: I personally would not have named my statewide elections database "Statewide Database," given the nonspecificity on both geography and data contents, but I have to admit it is a bit of a power move.

[^13]: Citation: Steven Manson, Jonathan Schroeder, David Van Riper, Katherine Knowles, Tracy Kugler, Finn Roberts, and Steven Ruggles. IPUMS National Historical Geographic Information System: Version 19.0 [dataset]. Minneapolis, MN: IPUMS. 2024. <http://doi.org/10.18128/D050.V19.0>
